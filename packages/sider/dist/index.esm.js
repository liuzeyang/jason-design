...
function TabNode(_ref, ref) {
  ...
  var node = /*#__PURE__*/createElement("div", {
    key: key,
    ref: ref,
    className: classNames(tabPrefix, (_classNames = {}, _defineProperty(_classNames, "".concat(tabPrefix, "-active"), active), _defineProperty(_classNames, "".concat(tabPrefix, "-disabled"), disabled), _classNames)),
    style: nodeStyle,
...
var TabNode$1 = /*#__PURE__*/forwardRef(TabNode);
...
var ExtraContent = function ExtraContent(_ref) {
  ...
  return content ? /*#__PURE__*/createElement("div", {
    className: "".concat(prefixCls, "-sider-extra-content")
  }, content) : null;
};

function SiderTabNav(props, ref) {
  var _React$useContext = useContext(SiderTabsContext),
  ...
  var tabNodes = tabs ? tabs.map(function (tab) {
    var key = tab.key;
    return /*#__PURE__*/createElement(TabNode$1, {
      id: id || key,
      prefixCls: prefixCls,
      key: key,
      tab: tab,
  ...
  }, /*#__PURE__*/createElement(ExtraContent, {
    position: "left",
    extra: extra,
    prefixCls: prefixCls
  }), /*#__PURE__*/createElement("div", {
    className: "".concat(prefixCls, "-sider-nav-list")
  }, tabNodes), /*#__PURE__*/createElement(ExtraContent, {
    position: "right",
    extra: extra,
    prefixCls: prefixCls
  }));
...
var SiderTabNav$1 = /*#__PURE__*/forwardRef(SiderTabNav);
...
var SiderTabs = function SiderTabs(props) {
  ...
  return /*#__PURE__*/React.createElement(SiderTabsContext.Provider, {
    ...
    handler: /*#__PURE__*/React.createElement("div", {
      className: classNames('sider-drawe', _defineProperty({}, "".concat(prefixCls, "-sider-").concat(size), size), "".concat(prefixCls, "-sider"), className),
      style: _objectSpread2(_objectSpread2({}, style), {}, {
        right: "".concat(width, "px")
      })
    }, /*#__PURE__*/React.createElement(SiderTabNav$1, Object.assign({}, tabNavBarProps))),
    style: {
      zIndex: 999
    },
    id: 'sider-drawer'
  }), /*#__PURE__*/React.createElement("div", {
    className: classNames("".concat(prefixCls, "-sider-content"), {})
  }, tabs.map(function (tab) {
